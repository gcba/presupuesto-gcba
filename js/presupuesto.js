function veoPresupuesto(year){
    ...
    switch (seleccion){
        case "2014":
            ...
            presupuesto("data/presupuesto2014.csv",6,6,["#ECD078", "#D95B43", "#C02942", "#542437", "#53777A"],170);
...
function presupuesto(archivo, vWidth,vFilas,pRango,vHeight){
